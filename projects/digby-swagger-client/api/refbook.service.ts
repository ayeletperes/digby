...
export class RefbookService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAscUsage(species: string, chain: string, asc: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public getAscUsage(species: string, chain: string, asc: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public getAscUsage(species: string, chain: string, asc: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public getAscUsage(species: string, chain: string, asc: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/refbook/asc_usage/${encodeURIComponent(String(species))}/${encodeURIComponent(String(chain))}/${encodeURIComponent(String(asc))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
